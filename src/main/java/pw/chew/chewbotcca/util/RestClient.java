...
public class RestClient {
    ...
    private static final String userAgent = "ChanServ-2619/1.0 (JDA; +https://discord.chew.pro) DBots/271750088383135745"; // ChanServ, Update user agent
    ...
    public static String performRequest(Request request) {
        try (Response response = ChanServ.getJDA().getHttpClient().newCall(request).execute()) { // ChanServ, change to use ChanServ JDA
            String body;
